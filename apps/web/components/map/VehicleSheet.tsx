...
export function VehicleSheet({ alias, online, speed, lastSeen, batteryVoltage, ignition, trips }: Props) {
  ...
  return (
    <div className="shadow-floating absolute inset-x-0 bottom-0 z-20 flex max-h-[75%] flex-col overflow-hidden rounded-t-3xl border border-b-0 border-(--color-border) bg-(--color-bg-surface)/92 px-4 pb-4 pt-2.5 backdrop-blur-md">
      <button
        type="button"
