  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          role="listbox"
          className="absolute left-0 top-[calc(100%+8px)] z-50 w-64 overflow-hidden rounded-2xl border border-[--color-border] bg-[--color-bg-surface]/90 shadow-lg shadow-black/20 backdrop-blur-md"
        >
          {vehicles.map(v => (
            <button
              key={v.id}
